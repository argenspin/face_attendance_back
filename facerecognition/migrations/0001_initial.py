# Generated by Django 4.1.3 on 2023-03-14 16:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='current_batch', to='facerecognition.academicbatch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dob', models.DateField(default=datetime.date(2023, 3, 14), null=True)),

...
SECRET_KEY = 'django-insecure-$cn!_l&)m2r#v%5#68a04@5-vv2(x52e$fw9a#+d#=xyv^lzrx'
...
REST_FRAMEWORK = {
    #The below values make sure that user is authenticated before returning Responses in views
